...
export interface MembershipPluginSetupInterface extends utils.Interface {
  functions: {
...
export interface MembershipPluginSetup extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MembershipPluginSetupInterface;
